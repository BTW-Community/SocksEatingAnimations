...
public class SEAItemMushroom extends SEAItemFood
{
    ...
    public SEAItemMushroom( int iItemID, int iHungerHealed, float fSaturationModifier, String sItemName, int iPlacedBlockID, String[] eatingTextures )
    {
