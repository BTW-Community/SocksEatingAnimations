...
public class SEAItemSeedFood extends SEAItemFood
{
    protected int m_iCropBlockID;
    
    public SEAItemSeedFood( int iItemID, int iHealAmount, float fSaturationModifier, 
    	int iCropBlockID, String sItemName, String[] eatingTextures )
    {    	
    	...
    	super( iItemID, iHealAmount, fSaturationModifier, false, sItemName, eatingTextures );
    	setMaxDamage( 0 ); //Disable progress bar
        setUnlocalizedName( sItemName );
        eatingProgressArray = eatingTextures;
