...
public class SEAItemCocoaBeans extends SEAItemFood
{
	...
	public SEAItemCocoaBeans( int iItemID, int iHungerHealed, float fSaturationModifier, String sItemName, String[] eatingTextures )
    {
